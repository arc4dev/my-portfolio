...
const Project = (props: Props) => {
  ...
  return (
    <div className="w-screen flex-shrink-0 snap-center flex justify-center items-center h-screen">
      <motion.article
        // onHoverStart={() => setIsOpen(true)}
        // onHoverEnd={() => setIsOpen(false)}
        className="w-[600px] relative bg-bgColorDarker backdrop-blur-md rounded-xl border border-gray-500/20 p-7 overflow-hidden shadow-sm cursor-pointer group hover:shadow-xl transition-all duration-200">
